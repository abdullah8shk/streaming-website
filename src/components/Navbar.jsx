  ...
  return (
    <nav className='navbar navbar-expand-lg navbar-dark bg-dark'>
      <div className='container-fluid'>
        <Link to='/' className='d-flex align-items-center home'>
          <svg
        ...
        <div className='collapse navbar-collapse'>
          <div className='navLinks topBotomBordersIn'>
            <Link to='/'>HOME</Link>
            <Link to='/movies'>MOVIES</Link>
            <Link to='/series'>SERIES</Link>
          </div>
        </div>
        <div className='col-md-3 d-flex align-items-center pr-0  pl-0 justify-content-end '>
          <SearchBar />
          <span className='profile pr-5 dropdown'>
            <img
